...
config.bind(',ll', 'spawn --userscript qute-lastpass --dmenu-invocation rofi -dmenu')
config.bind(',lu', 'spawn --userscript qute-lastpass -e')
config.bind(',lp', 'spawn --userscript qute-lastpass -w')
config.set('colors.webpage.darkmode.enabled', True)
config.set('colors.webpage.bg', "black")
config.set('auto_save.session', True)
config.bind('<Alt-Shift-p>', 'spawn --userscript qute-keepassxc --insecure', mode='insert')
